        ...
        <div>
          <p>
            ...
            <span style={styles.paragraph}>
              At Otherhome Pty Ltd, I designed, set up, and managed a
              cloud-based server infrastructure to support an in-house messaging
              application, optimizing for both performance and cost-efficiency.
              Also built the company’s email system, developed its main website
              and ticketing platform using WordPress, and improved customer
              communication. I also designed and implemented a CI/CD pipeline
              for a LAMP stack-based community website for Korean immigrants,
              which I developed and that has over 250,000 visitors.
            </span>
            <br></br>
            <br></br>
