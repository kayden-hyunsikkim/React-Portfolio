  ...
  return (
    <>
      <footer className="footer" style={footerStyle}>
        <a>
          <img src={phone} />
          <p onClick="alert('0433949969')">0433949969</p>
        </a>
        <a>
          <img src={email} />
          <p onClick={handleClick}>kayden190116@gmail.com</p>
        </a>
        <a
          href="https://github.com/kayden-hyunsikkim?tab=repositories"
          target="_blank"
        >
          <img src={github} />
          <p>Github</p>
        ...
        <a
          href="https://www.linkedin.com/in/hyunsik-kim-b88173246/"
          target="_blank"
        >
          <img src={linkedin} />
          <p>Linkedin</p>
